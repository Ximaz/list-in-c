...
Test(list_equal, test_impl)
{
    ...
    cr_assert(eq(int, 0, list_insert_at(list1, strdup("This is my head !"), 0)));
    cr_assert(eq(int, 0, list_insert_at(list1, strdup("This is my tail !"), 1)));
    cr_assert(eq(int, 0, list_insert_at(list1, strdup("This is my tail 2-1 !"), -1)));
    cr_assert(eq(int, 0, list_insert_at(list1, strdup("This is my tail 2 !"), 2)));
